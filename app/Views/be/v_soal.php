            ...
            <div class="row">
                <div class="col-12">
                    <div class="text-end my-3">
                        ...
                        <a href="<?php echo base_url('/be_ekspor_excel_soal&id=' . $id) ?>">
                            <button type="button" class="btn btn-success ">
                                <i class="fa fa-file"></i> Ekspor Excel
                            </button>
                        </a>

                        <a href="<?php echo base_url('/be_ekspor_pdf_soal&id=' . $id) ?>">
                            <button type="button" class="btn btn-danger ">
                                <i class="fa fa-file"></i> Ekspor PDF
                            </button>
                        </a>

                        <a href="<?php echo base_url('/be_create_soal&id=' . $id) ?>">
                    ...
                    <div class="portlet">
                        <?php if (!empty($item)) { ?>
                            <div class="portlet-header portlet-header-bordered">
                                <h3 class="portlet-title">Data Soal</h3>
                            </div>
                                        ...
                                        <?php foreach ($item as $data) { ?>
                                            <tr>
                                                ...
                                                <td class="text-end text-primary">
                                                    <a href="<?php echo base_url('/be_edit_soal&id=' . $data['id']) ?>">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Impor Data Soal</h5>
                </div>
                <form method="post" action="<?php echo base_url('importSoal&id=' . $id) ?>" enctype="multipart/form-data">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <div class="btn-inline">
                            <a href="#" class="btn btn-text-secondary" data-bs-dismiss="modal">CANCEL</a>
                            <a href="<?php echo base_url('/be_hapus_soal&id=' . $data['id']) ?>" class="btn btn-text-primary">
                                IYA
                            </a>
                        </div>
                    </div>
