            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet">
                        ...
                        <form action="<?php echo base_url('/be_proses_edit_quiz&id=' . $idpembelajaran) ?>" method="post">
                                ...
                                <div class="d-grid gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" name="jawaban1" aria-label="jawaban1" class="form-control" value="<?= $item['jawaban1']; ?>">
                                            <input type="text" name="jawaban2" aria-label="jawaban2" class="form-control" value="<?= $item['jawaban2']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="opsi4" class="form-control" value="<?= $item['opsi4']; ?>">
                                    </div>
